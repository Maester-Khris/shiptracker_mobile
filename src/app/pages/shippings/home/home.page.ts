...
export class HomePage implements OnInit {
  ...
  async getShippings(){
    ...
    this.remote.getMyShipping({user_email:user.email}).subscribe((response:HttpResponse<any>)=>{
  ...
  scanLogic() {
    ...
    window.open("https://www.olbizgo.com/userpace/expeditions?shipcode=${this.code}");
  }
